...
class HistoryAppointmentsList extends StatefulWidget {
  ...
  @override
  State<HistoryAppointmentsList> createState() =>
      _HistoryAppointmentsListState();
}

class _HistoryAppointmentsListState extends State<HistoryAppointmentsList> {
